...
export const SearchControls = () => {
    ...
    const inputRef = useRef<HTMLInputElement>(null); //Nos sirve para mantener un valor que no cambia entre re-render y que su cambio no afecta a la renderización del mismo
